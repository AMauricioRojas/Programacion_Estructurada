    ...
    while opcion:
        ...
        if opcion=="1" or opcion=="REGISTRO":
            ...
            if lista_usuario:
                ...
                print("Email y/o contraseña incorrectos,poer favor verifica y vuelve a intentar")
                funciones.esperarTecla()
...
def menu_notas(usuario_id,nombre,apellidos):
    while True:
        ...
        if opcion == '1' or opcion=="CREAR":
            ...
            if resultado:
                print(f"\n\tSe creo satisfactoriamente la nota:{nota} :{titulo}")
            else:
                print("\n\tNo fue posible crear la nota en este momento por favor intentar mas tarde")
            funciones.esperarTecla()    
